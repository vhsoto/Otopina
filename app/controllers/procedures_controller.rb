class ProceduresController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @procedure.save
        format.html { redirect_to procedures_path, notice: 'Procedimiento ingresado satisfactoriamente.' }
  ...
  def update
    respond_to do |format|
      if @procedure.update(procedure_params)
        format.html { redirect_to procedures_path, notice: 'Procedimiento actualizado satisfactoriamente.' }
  ...
  def destroy
    @procedure.destroy
    respond_to do |format|
      format.html { redirect_to procedures_url, notice: 'Procedimiento eliminado satisfactoriamente.' }
